...
class ValuationModel(models.Model):
    ...
    correlation_file_path = models.CharField(max_length=255, blank=True, null=True)
    scaler_file_path = models.CharField(max_length=255, blank=True, null=True)
    columns_file_path = models.CharField(max_length=255, blank=True, null=True)
