    ...
    try:
        ...
        if sq and district and city and floor != None and rooms and year and prediction_month and prediction_year:
            ...
            search = ApartmentSearch.objects.create(
                ...
                square_meters=sq,
                year=year,
                suggested_price_min=int(lower_price),
                suggested_price_max=int(upper_price),
            ...
            return JsonResponse({'price': {'lower': search.suggested_price_min, 'upper': search.suggested_price_max, }, 'percent': search.percent, 'tokens':user.valuation_tokens}, status=200)
        else:
